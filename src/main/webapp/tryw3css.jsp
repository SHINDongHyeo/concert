  ...
  <div class="w3-bar w3-black w3-card">
    ...
    <div class="w3-dropdown-hover w3-hide-small">
      <button class="w3-padding-large w3-button" title="More">
        <i class="material-icons" style="font-size:17px;color:white">more_horiz</i>더보기<i class="fa fa-caret-down"></i></button>     
...
<!-- 
  ...
  <div class="w3-container w3-content w3-center w3-padding-64" style="max-width:1000px" id="band">
    ...
    <!-- <div class="w3-row w3-padding-32">
      ...
      <div class="w3-third">
        <p>IU</p>
        <img src="images/2_iu.jpg" class="w3-round w3-margin-bottom" alt="Random Name" style="width:60%">
      </div>
      <div class="w3-third">
        <p>Queen</p>
  ...
  <div class="w3-container w3-content w3-padding-64" style="max-width:800px" id="contact">
    ...
    <div class="w3-row w3-padding-32">
      <div class="w3-col m6 w3-large w3-margin-bottom">
        <i class="fa fa-map-marker" style="width:30px; color:aqua;"></i> Chicago, US<br>
