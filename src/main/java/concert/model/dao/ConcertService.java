...
public class ConcertService {
	...
	public ArrayList<Integer> getSingersByConcert(int concertId) throws SQLException,NotExistException{
		ArrayList<Integer> result = concertSingerDAO.getSingersByConcert(concertId);
		return result;
	}
